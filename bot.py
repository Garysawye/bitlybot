...
async def start(client,message):
  await message.reply_text(f"Greetings {message .from_user.first_name}\nI'm bit.ly short link genrator\n made with love by @master_sergio \n Support by Joining @Cracked_Premium_Accounts ", reply_to_message_id = message.message_id)
